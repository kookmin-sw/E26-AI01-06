# Welcome to E26-AI01-06

## 🎯 팀 슬로건

상상은 다르게, 꿈은 크게, 미래는 함께
...
| **이름** | **전공** | **관심사** |
| --- | --- | --- |
| **현민준** | 인공지능전공 | 게임 개발, 영화 관람 |
| **임재희** | 인공지능전공 | 코딩, 인공지능, 프로그래밍, 웹 |
| **비타** | 인공지능전공 | 운동, 인공지능, 음악, 앱이나 웹 디자인 |
...
우리 팀의 미래는 아직 불확실하고, 서로 다른 길을 걷게 될지도 모르지만 이 활동을 통해 조금이나마 서로를 이해하고 함께 성장하는 팀이 되고 싶습니다.

***

## 2️⃣ 공통된 관심사 : 영화 관람, 여행, 개발
...
* 실현됨 - 모바일 결제, 모바일 인증, 사물인터넷 터치스크린
* 일부 실현 - 휴머노이드 AI, 원격 수술
* 아직 미실현 - 우주 수학여행
* 방향 전환 - 전자 신문
...
* Why - 장소의 제약 없이 영상을 보고 싶었다.
* What - 사용자 개개인에 맞춰 자동으로 영상을 추천해 온라인으로 실행한다.
* How - Netflix 등 온라인 플랫폼으로 스마트폰과 같은 디지털 기기로 접근하여 영상을 추천받고 실행할 수 있게 되었다.
* Next - 더 다양한 언어로 콘텐츠를 제공하고 여러 플랫폼을 통합한 종합 스트리밍 플랫폼이 탄생하여 거의 모든 콘텐츠를 즐길 수 있게 될 것이다.
